...
export interface IController {
     ...
     */
    onClick(tree: ITree, element: any, event: monaco.IMouseEvent): boolean;
    /**
     ...
     */
    onTap(tree: ITree, element: any, event: GestureEvent): boolean;
    /**
     * Called when a key is pressed down while selecting elements.
     */
    onKeyDown(tree: ITree, event: monaco.IKeyboardEvent): boolean;
    /**
     * Called when a key is released while selecting elements.
     */
    onKeyUp(tree: ITree, event: monaco.IKeyboardEvent): boolean;
    /**
     * Called when a mouse button is pressed down on an element.
     */
    onMouseDown?(tree: ITree, element: any, event: monaco.IMouseEvent): boolean;
    /**
     * Called when a mouse button goes up on an element.
     */
    onMouseUp?(tree: ITree, element: any, event: monaco.IMouseEvent): boolean;
}
...
export interface IDragAndDrop {
     ...
     */
    onDragOver(tree: ITree, data: IDragAndDropData, targetElement: any, originalEvent: DragMouseEvent): IDragOverReaction;
    /**
     * Handles the action of dropping sources into target.
     */
    drop(tree: ITree, data: IDragAndDropData, targetElement: any, originalEvent: DragMouseEvent): void;
}
...
export declare type IElementCallback = (tree: ITree, element: any) => void;
...
export interface ITreeOptions extends ITreeStyles {
    ...
    showTwistie?: boolean;
    indentPixels?: number;
    verticalScrollMode?: monaco.editor.ScrollbarVisibility;
